...
Arbetet som en IT-säkerhetstekniker utför  är ett mångsidigt,
teknikern ansvarar för att säkerställa att den befintliga IT-infrastrukturen är intakt och härdad.
För att arbeta som IT-säkerhetstekniker kräver det att en person är redo för ett varierande arbete,
och att du har en en mångsidig uppsättning av kompetenser, som nätverkshantering, hantering av tekniska säkerhetsincidenter och kunskap om vanliga sårbarheter.

#### Jag tycker yrket låter spännande och visar lovande utvecklingspotential med olika kompetenser.
...
#### Min åsikt är att  det här jobbet verkar väldigt spännande pågrund av att det är ett arbete som hanterar hot och risker som är i konstant förändring.
